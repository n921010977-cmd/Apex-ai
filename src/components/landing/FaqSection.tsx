...
const FAQ = [
  {
    ...
    a: "Это реальные AI-агенты на базе передовых языковых моделей. Каждый из 20 экспертов анализирует именно ваш бизнес, а не подставляет вас в шаблон. CEO синтезирует результаты всей команды в единый отчёт.",
  },
  {
  ...
  },
  {
    ...
    a: "3 полных анализа в месяц, все 20 AI-экспертов, финансовые прогнозы, анализ рисков, рыночный анализ и резюме стратегии. Без кредитной карты.",
  },
  {
