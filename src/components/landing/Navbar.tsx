    ...
    >
      <nav aria-label="Main navigation" className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-2.5 group rounded-lg" aria-label="Vertlix Command Center — home">
          <div
            className="size-9 flex items-center justify-center flex-shrink-0 transition-shadow duration-300 group-hover:shadow-[0_4px_20px_rgba(124,58,237,0.35)]"
            style={{
              borderRadius: 10,
              background: "linear-gradient(135deg, #7C3AED, #6D28D9)",
              boxShadow: "0 2px 12px rgba(124,58,237,0.25), inset 0 1px 0 rgba(255,255,255,0.18)",
            }}
          >
        ...
        <div className="flex items-center gap-2.5">
          ...
          <Link
            href="/register"
            className="term-mono inline-flex items-center gap-2 h-9 px-5 text-[11px] tracking-[0.08em] uppercase font-semibold text-white rounded-lg transition-all duration-200 hover:-translate-y-px hover:shadow-[0_8px_24px_rgba(124,58,237,0.35)]"
            style={{
              background: "linear-gradient(135deg, #7C3AED, #6D28D9)",
              boxShadow: "0 4px 16px rgba(124,58,237,0.28), inset 0 1px 0 rgba(255,255,255,0.16)",
            }}
          >
            Start free
          </Link>
