...
const NAV_ITEMS = [
  { label: "Dashboard", href: "/dashboard", exact: true, icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="size-4"><rect x="3" y="3" width="7" height="7" rx="1" /><rect x="14" y="3" width="7" height="7" rx="1" /><rect x="14" y="14" width="7" height="7" rx="1" /><rect x="3" y="14" width="7" height="7" rx="1" /></svg> },
  { label: "Новая стратегия", href: "/dashboard/new", accent: true, icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="size-4"><circle cx="12" cy="12" r="10" /><line x1="12" y1="8" x2="12" y2="16" /><line x1="8" y1="12" x2="16" y2="12" /></svg> },
  ...
  { label: "Отчёты", href: "/dashboard/reports", icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="size-4"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><polyline points="14 2 14 8 20 8" /><line x1="16" y1="13" x2="8" y2="13" /><line x1="16" y1="17" x2="8" y2="17" /></svg> },
  { label: "Исполнительный совет", href: "/dashboard/executives", icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="size-4"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" /><circle cx="9" cy="7" r="4" /><path d="M23 21v-2a4 4 0 0 0-3-3.87" /><path d="M16 3.13a4 4 0 0 1 0 7.75" /></svg> },
  { label: "Аналитика", href: "/dashboard/analytics", icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="size-4"><line x1="18" y1="20" x2="18" y2="10" /><line x1="12" y1="20" x2="12" y2="4" /><line x1="6" y1="20" x2="6" y2="14" /></svg> },
...
const BOTTOM_ITEMS = [
  ...
  { label: "Помощь и поддержка", href: "/dashboard/support", icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="size-4"><circle cx="12" cy="12" r="10" /><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3" /><line x1="12" y1="17" x2="12.01" y2="17" /></svg> },
];
    ...
    <aside className="w-60 flex-shrink-0 flex flex-col h-screen sticky top-0 border-r border-white/[0.06] bg-[#0a0a0a]">
      <div className="h-16 flex items-center px-5 border-b border-white/[0.06]">
        <Link href="/" className="flex items-center gap-2.5">
          ...
          <div>
            <div className="text-xs font-bold text-white leading-tight">Apex AI</div>
            ...
            <Link
              ...
              className={cn(
                ...
                active
                  ...
                  : item.accent
                  ? "text-violet-400 hover:bg-violet-500/10 hover:text-violet-300 border border-transparent"
                  : "text-white/40 hover:text-white/80 hover:bg-white/[0.04] border border-transparent"
              )}
            >
              <span className={cn(active ? "text-violet-400" : item.accent ? "text-violet-500" : "text-white/30 group-hover:text-white/60")}>
                {item.icon}
              </span>
              {item.label}
      ...
      <div className="mx-3 mb-3 p-3 rounded-xl bg-white/[0.03] border border-white/[0.06]">
        <div className="flex items-center justify-between mb-2">
          <span className="text-xs text-white/40">Отчётов в месяц</span>
        ...
        <Link href="/dashboard/settings" className="mt-2 text-[10px] text-violet-400 hover:text-violet-300 transition-colors block">Upgrade to Pro →</Link>
      </div>
      ...
      <div className="px-3 pb-4 space-y-0.5 border-t border-white/[0.06] pt-3">
        {BOTTOM_ITEMS.map((item) => {
          ...
          return (
            ...
            >
              <span className={cn(active ? "text-violet-400" : "text-white/25 group-hover:text-white/50")}>{item.icon}</span>
              {item.label}
            </Link>
          );
        })}
