...
export const TEAM: TeamMember[] = [
  ...
  { slug: "cto", ab: "AP", name: "Aiden Park",    role: "CTO", title: "Chief Technology Officer", dept: "tech",       tier: "c-level", reportsTo: "ceo", c: "#a855f7", g: ["#a855f7", "#7e22ce"] },
  // ── Finance → CFO ──
  { slug: "analyst",  ab: "KP", name: "Kim Park",     role: "Analyst",  title: "Business Analyst",     dept: "finance",    tier: "specialist", reportsTo: "cfo", c: "#0ea5e9", g: ["#0ea5e9", "#0369a1"] },
  { slug: "invest",   ab: "TE", name: "Tom Evans",    role: "IR",       title: "Investment Analyst",   dept: "finance",    tier: "specialist", reportsTo: "cfo", c: "#14b8a6", g: ["#14b8a6", "#0f766e"] },
  { slug: "risk",     ab: "OH", name: "Omar Hassan",  role: "Risk",     title: "Risk Manager",         dept: "finance",    tier: "specialist", reportsTo: "cfo", c: "#f43f5e", g: ["#f43f5e", "#be123c"] },
  // ── Marketing → CMO ──
  { slug: "brand",    ab: "CM", name: "Chloe Martin", role: "Brand",    title: "Brand Strategist",     dept: "marketing",  tier: "specialist", reportsTo: "cmo", c: "#d946ef", g: ["#d946ef", "#a21caf"] },
  { slug: "growth",   ab: "AK", name: "Alex Kim",     role: "Growth",   title: "Growth Director",      dept: "marketing",  tier: "specialist", reportsTo: "cmo", c: "#84cc16", g: ["#84cc16", "#4d7c0f"] },
  { slug: "market",   ab: "NB", name: "Nina Brown",   role: "Research", title: "Market Analyst",       dept: "marketing",  tier: "specialist", reportsTo: "cmo", c: "#06b6d4", g: ["#06b6d4", "#0e7490"] },
  { slug: "pr",       ab: "LF", name: "Liam Foster",  role: "PR",       title: "PR Director",          dept: "marketing",  tier: "specialist", reportsTo: "cmo", c: "#fb7185", g: ["#fb7185", "#e11d48"] },
  // ── Operations → COO ──
  { slug: "sales",    ab: "RC", name: "Ryan Cole",    role: "Sales",    title: "Sales Director",       dept: "operations", tier: "specialist", reportsTo: "coo", c: "#22c55e", g: ["#22c55e", "#15803d"] },
  { slug: "hr",       ab: "MS", name: "Maya Scott",   role: "HR",       title: "HR Director",          dept: "operations", tier: "specialist", reportsTo: "coo", c: "#ec4899", g: ["#ec4899", "#be185d"] },
  { slug: "legal",    ab: "ML", name: "Mia Larson",   role: "Legal",    title: "Legal Advisor",        dept: "operations", tier: "specialist", reportsTo: "coo", c: "#94a3b8", g: ["#94a3b8", "#475569"] },
  { slug: "supply",   ab: "JT", name: "Jake Turner",  role: "Supply",   title: "Supply Chain",         dept: "operations", tier: "specialist", reportsTo: "coo", c: "#eab308", g: ["#eab308", "#a16207"] },
  // ── Tech & Product → CTO ──
  { slug: "data",     ab: "LZ", name: "Leo Zhang",    role: "Data",     title: "Data Scientist",       dept: "tech",       tier: "specialist", reportsTo: "cto", c: "#7c3aed", g: ["#7c3aed", "#5b21b6"] },
