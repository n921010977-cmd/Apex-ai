        ...
        <div className="bg-white/[0.03] border border-white/[0.07] rounded-2xl p-6">
          <div className="space-y-2 mb-5">
            <button
              ...
              className="w-full h-10 flex items-center justify-center gap-3 text-sm font-medium text-white/70 border border-white/[0.08] rounded-xl hover:border-white/[0.15] hover:bg-white/[0.04] transition-all"
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <label className="flex items-start gap-2.5 cursor-pointer mt-1">
              <div
                ...
                className={`size-4 rounded flex items-center justify-center flex-shrink-0 mt-0.5 border transition-all ${form.agree ? "bg-violet-600 border-violet-600" : "border-white/[0.15] bg-white/[0.04]"}`}
              >
            ...
            >
              {loading ? <span className="size-4 border-2 border-white/30 border-t-white rounded-full animate-spin" /> : "Создать аккаунт"}
            </button>
          </form>
        </div>
