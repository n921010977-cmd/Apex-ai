...
// Плейсхолдеры [В КВАДРАТНЫХ СКОБКАХ] заменить на реквизиты оператора.
...
const SECTIONS: Section[] = [
  {
    ...
    blocks: [
      { kind: "p", text: "Создавая аккаунт в Vertlix AI (далее — «Сервис»), вы даёте оператору — [УКАЖИТЕ ЮРИДИЧЕСКОЕ ЛИЦО / ИП / САМОЗАНЯТОГО] (далее — «Оператор», «мы») — согласие на обработку ваших персональных данных на условиях, описанных ниже и в Политике конфиденциальности." },
  ...
  },
  {
    ...
    blocks: [
      ...
      { kind: "p", text: "Оператор: [УКАЖИТЕ ЮРИДИЧЕСКОЕ ЛИЦО / ИП / САМОЗАНЯТОГО], адрес: [ЮРИДИЧЕСКИЙ АДРЕС]." },
    ],
  },
];
