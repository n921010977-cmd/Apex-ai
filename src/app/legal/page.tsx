...
const SECTIONS = [
  ...
  },
  {
    ...
    body: [
      "Apex AI предоставляет аналитические и стратегические рекомендации на базе искусственного интеллекта. Это инструмент поддержки принятия решений, а не замена профессиональной консультации.",
    ...
    <div style={{ minHeight: "100vh", background: "#05060A", color: "#fff" }}>
      ...
      <header style={{ borderBottom: "1px solid rgba(255,255,255,0.07)", padding: "0 24px", height: 58, display: "flex", alignItems: "center", position: "sticky", top: 0, background: "rgba(5,6,10,0.85)", backdropFilter: "blur(20px)", zIndex: 10 }}>
        <Link href="/" style={{ display: "flex", alignItems: "center", gap: 9, textDecoration: "none" }}>
          ...
          <span style={{ fontSize: 15, fontWeight: 800 }}>Apex AI</span>
        </Link>
      </header>
