...
const AGENTS_ALL: Agent[] = [
  { id:"a1",  name:"Sophia Rivers",      role:"Chief Executive Officer",     dept:"exec",      emoji:"👑", color:"#6366f1", description:"Стратегическое руководство, принятие ключевых решений и управление исполнительной командой.",       model:"claude-opus-4-8",  status:"active", runs:0, rating:0, speed:"medium", cost:"$$$", tools:["web","docs","analytics"],        memory:true,  created:"2024-01-15", prompt:"Ты Sophia Rivers — CEO с 20-летним опытом. Принимаешь стратегические решения, координируешь топ-менеджмент." },
  { id:"a2",  name:"Marcus Webb",        role:"Chief Strategy Officer",      dept:"exec",      emoji:"🎯", color:"#3b82f6", description:"Долгосрочное планирование, конкурентный анализ и трансформация бизнес-модели.",                    model:"claude-sonnet-5",  status:"active", runs:0, rating:0, speed:"fast",   cost:"$$",  tools:["web","analytics","docs"],        memory:true,  created:"2024-01-20", prompt:"Ты Marcus Webb — CSO. Разрабатываешь долгосрочные стратегии, анализируешь рынок." },
  { id:"a3",  name:"James Wright",       role:"Chief Operating Officer",     dept:"exec",      emoji:"⚙️", color:"#f59e0b", description:"Оптимизация операций, KPI, процессы и операционная эффективность.",                               model:"claude-sonnet-5",  status:"idle",   runs:0, rating:0, speed:"fast",   cost:"$$",  tools:["docs","analytics"],              memory:true,  created:"2024-01-18", prompt:"Ты James Wright — COO. Управляешь операционными процессами, оптимизируешь KPI." },
  { id:"a4",  name:"Marcus Chen",        role:"Chief Financial Officer",     dept:"exec",      emoji:"💼", color:"#3b82f6", description:"Финансовое планирование, бюджет, риски и инвестиционные решения.",                                 model:"claude-opus-4-8",  status:"active", runs:0, rating:0, speed:"medium", cost:"$$$", tools:["docs","analytics","calculator"], memory:true,  created:"2024-01-16", prompt:"Ты Marcus Chen — CFO. Управляешь финансами, строишь прогнозы, анализируешь P&L." },
  { id:"a5",  name:"Elena Torres",       role:"Chief Marketing Officer",     dept:"exec",      emoji:"📣", color:"#10b981", description:"Бренд-стратегия, маркетинг-микс, рост и удержание аудитории.",                                    model:"claude-sonnet-5",  status:"active", runs:0, rating:0, speed:"fast",   cost:"$$",  tools:["web","docs","image"],            memory:true,  created:"2024-02-01", prompt:"Ты Elena Torres — CMO. Отвечаешь за бренд, маркетинговые кампании и рост аудитории." },
  { id:"a6",  name:"Aiden Park",         role:"Chief Technology Officer",    dept:"exec",      emoji:"🔬", color:"#a855f7", description:"Технологическая стратегия, архитектура, R&D и инновации.",                                          model:"claude-opus-4-8",  status:"idle",   runs:0, rating:0, speed:"medium", cost:"$$$", tools:["code","web","docs"],             memory:true,  created:"2024-02-05", prompt:"Ты Aiden Park — CTO. Определяешь технологическую стратегию, архитектуру систем." },
  ...
  { id:"a8",  name:"Robert Kim",         role:"Investment Analyst",          dept:"finance",   emoji:"💹", color:"#10b981", description:"Оценка инвестиций, due diligence и портфельный анализ.",                                            model:"claude-sonnet-5",  status:"idle",   runs:0, rating:0, speed:"fast",   cost:"$$",  tools:["web","calculator","docs"],       memory:false, created:"2024-02-12", prompt:"Ты Robert Kim — инвестиционный аналитик. Проводишь due diligence, оцениваешь проекты." },
  { id:"a9",  name:"Natasha Orlov",      role:"Tax & Compliance",           dept:"finance",   emoji:"📋", color:"#3b82f6", description:"Налоговое планирование, комплаенс и регуляторная отчётность.",                                      model:"gpt-4o",           status:"active", runs:0, rating:0, speed:"medium", cost:"$$",  tools:["docs","web"],                    memory:true,  created:"2024-03-01", prompt:"Ты Natasha Orlov — налоговый специалист. Консультируешь по налогам, комплаенс-вопросам." },
  { id:"a10", name:"Felix Bauer",        role:"Budget Controller",           dept:"finance",   emoji:"🔢", color:"#f43f5e", description:"Контроль бюджетов, план/факт анализ и оптимизация расходов.",                                      model:"claude-sonnet-5",  status:"idle",   runs:0, rating:0, speed:"fast",   cost:"$",   tools:["calculator","docs"],             memory:false, created:"2024-03-05", prompt:"Ты Felix Bauer — контроллер бюджетов. Анализируешь план-факт, оптимизируешь расходы." },
  { id:"a11", name:"Isabella Torres",    role:"Treasury Manager",            dept:"finance",   emoji:"🏦", color:"#8b5cf6", description:"Управление ликвидностью, валютные риски и казначейские операции.",                                  model:"claude-sonnet-5",  status:"active", runs:0, rating:0, speed:"medium", cost:"$$",  tools:["calculator","web","docs"],       memory:true,  created:"2024-03-10", prompt:"Ты Isabella Torres — казначей. Управляешь ликвидностью, хеджируешь валютные риски." },
  { id:"a12", name:"Leo Fontaine",       role:"Growth Hacker",               dept:"marketing", emoji:"🚀", color:"#f43f5e", description:"Эксперименты роста, A/B тесты и вирусные механики.",                                               model:"claude-sonnet-5",  status:"active", runs:0, rating:0, speed:"fast",   cost:"$",   tools:["web","analytics"],               memory:false, created:"2024-02-15", prompt:"Ты Leo Fontaine — growth hacker. Проводишь A/B тесты, ищешь каналы роста." },
  { id:"a13", name:"Maya Patel",         role:"Content Strategist",          dept:"marketing", emoji:"✍️", color:"#a78bfa", description:"Контент-стратегия, SEO и редакционный план.",                                                     model:"claude-sonnet-5",  status:"active", runs:0, rating:0, speed:"fast",   cost:"$",   tools:["web","docs","image"],            memory:false, created:"2024-02-18", prompt:"Ты Maya Patel — контент-стратег. Создаёшь контент-планы, оптимизируешь SEO." },
  { id:"a14", name:"Ethan Brooks",       role:"Performance Marketer",        dept:"marketing", emoji:"📈", color:"#10b981", description:"Платный трафик, ROAS, атрибуция и оптимизация рекламных кампаний.",                                model:"gpt-4o",           status:"idle",   runs:0, rating:0, speed:"fast",   cost:"$$",  tools:["web","analytics","docs"],        memory:false, created:"2024-02-20", prompt:"Ты Ethan Brooks — performance маркетолог. Управляешь платным трафиком, оптимизируешь ROAS." },
  { id:"a15", name:"Zoe Lambert",        role:"Brand Designer",              dept:"marketing", emoji:"🎨", color:"#f59e0b", description:"Визуальная идентичность, дизайн-система и брендинг.",                                              model:"claude-sonnet-5",  status:"active", runs:0, rating:0, speed:"medium", cost:"$$",  tools:["image","docs"],                  memory:true,  created:"2024-03-01", prompt:"Ты Zoe Lambert — бренд-дизайнер. Создаёшь визуальные концепции, развиваешь дизайн-систему." },
  { id:"a16", name:"Carlos Reyes",       role:"SEO Specialist",              dept:"marketing", emoji:"🔍", color:"#3b82f6", description:"Технический SEO, ссылочный профиль и ранжирование.",                                              model:"gpt-4o",           status:"idle",   runs:0, rating:0, speed:"fast",   cost:"$",   tools:["web","docs","analytics"],        memory:false, created:"2024-03-10", prompt:"Ты Carlos Reyes — SEO специалист. Проводишь технический аудит, строишь ссылочный профиль." },
  { id:"a17", name:"Nina Kowalski",      role:"Social Media Manager",        dept:"marketing", emoji:"📱", color:"#8b5cf6", description:"SMM стратегия, контент-план и развитие сообщества.",                                               model:"claude-sonnet-5",  status:"active", runs:0, rating:0, speed:"fast",   cost:"$",   tools:["web","docs","image"],            memory:false, created:"2024-03-15", prompt:"Ты Nina Kowalski — SMM менеджер. Ведёшь социальные сети, развиваешь сообщество." },
  { id:"a18", name:"Thomas Grant",       role:"Email Marketing",             dept:"marketing", emoji:"📧", color:"#f43f5e", description:"Автоматизация рассылок, триггерные цепочки и конверсия.",                                          model:"claude-sonnet-5",  status:"idle",   runs:0, rating:0, speed:"fast",   cost:"$",   tools:["docs","analytics"],              memory:false, created:"2024-03-20", prompt:"Ты Thomas Grant — email маркетолог. Создаёшь триггерные цепочки, оптимизируешь конверсию." },
  { id:"a19", name:"Olivia Nash",        role:"Account Executive",           dept:"sales",     emoji:"🤝", color:"#10b981", description:"Управление ключевыми клиентами, переговоры и закрытие сделок.",                                   model:"claude-sonnet-5",  status:"active", runs:0, rating:0, speed:"fast",   cost:"$$",  tools:["web","docs","crm"],              memory:true,  created:"2024-02-25", prompt:"Ты Olivia Nash — Account Executive. Ведёшь ключевых клиентов, закрываешь сделки." },
  { id:"a20", name:"Ryan Foster",        role:"Sales Development Rep",       dept:"sales",     emoji:"📞", color:"#f59e0b", description:"Квалификация лидов, холодные звонки и заполнение воронки.",                                       model:"claude-sonnet-5",  status:"active", runs:0, rating:0, speed:"fast",   cost:"$",   tools:["web","docs"],                    memory:false, created:"2024-03-01", prompt:"Ты Ryan Foster — SDR. Квалифицируешь лидов, пишешь холодные письма." },
  { id:"a21", name:"Priya Sharma",       role:"Customer Success Manager",    dept:"sales",     emoji:"💎", color:"#a78bfa", description:"Онбординг, удержание клиентов и развитие аккаунтов.",                                             model:"claude-sonnet-5",  status:"idle",   runs:0, rating:0, speed:"fast",   cost:"$$",  tools:["docs","web","analytics"],        memory:true,  created:"2024-03-05", prompt:"Ты Priya Sharma — CSM. Онбординг, удержание, развитие аккаунтов." },
  { id:"a22", name:"Samuel Cole",        role:"Revenue Operations",          dept:"sales",     emoji:"⚡", color:"#3b82f6", description:"CRM, RevOps, прогнозирование выручки и оптимизация воронки.",                                     model:"claude-sonnet-5",  status:"active", runs:0, rating:0, speed:"fast",   cost:"$$",  tools:["analytics","docs","calculator"], memory:true,  created:"2024-03-10", prompt:"Ты Samuel Cole — RevOps. Управляешь CRM, строишь прогнозы выручки." },
  { id:"a23", name:"Aria Bloom",         role:"Product Manager",             dept:"product",   emoji:"🗺️", color:"#8b5cf6", description:"Roadmap, приоритизация, пользовательские исследования и запуск фич.",                             model:"claude-opus-4-8",  status:"active", runs:0, rating:0, speed:"medium", cost:"$$$", tools:["docs","web","analytics"],        memory:true,  created:"2024-02-01", prompt:"Ты Aria Bloom — Product Manager. Ведёшь roadmap, приоритизируешь задачи." },
  { id:"a24", name:"Nathan Cross",       role:"UX Researcher",               dept:"product",   emoji:"🔬", color:"#10b981", description:"Юзабилити-исследования, интервью и синтез инсайтов.",                                             model:"claude-sonnet-5",  status:"idle",   runs:0, rating:0, speed:"medium", cost:"$$",  tools:["web","docs"],                    memory:true,  created:"2024-02-10", prompt:"Ты Nathan Cross — UX Researcher. Проводишь исследования, синтезируешь инсайты." },
  { id:"a25", name:"Sophie Müller",      role:"UX/UI Designer",              dept:"product",   emoji:"🎭", color:"#f43f5e", description:"Интерфейсный дизайн, прототипирование и дизайн-система.",                                         model:"claude-sonnet-5",  status:"active", runs:0, rating:0, speed:"fast",   cost:"$$",  tools:["image","docs"],                  memory:true,  created:"2024-02-15", prompt:"Ты Sophie Müller — UX/UI дизайнер. Создаёшь интерфейсы, прототипируешь решения." },
  { id:"a26", name:"Liam O'Brien",       role:"Product Analyst",             dept:"product",   emoji:"📉", color:"#a78bfa", description:"Продуктовая аналитика, funnel-анализ и метрики вовлечённости.",                                  model:"claude-sonnet-5",  status:"idle",   runs:0, rating:0, speed:"fast",   cost:"$",   tools:["analytics","docs","web"],        memory:false, created:"2024-02-20", prompt:"Ты Liam O'Brien — продуктовый аналитик. Анализируешь воронку, метрики вовлечённости." },
  { id:"a27", name:"Kai Tanaka",         role:"Full-Stack Developer",        dept:"dev",       emoji:"💻", color:"#3b82f6", description:"Разработка фич, архитектура и code review.",                                                     model:"claude-sonnet-5",  status:"active", runs:0, rating:0, speed:"fast",   cost:"$$",  tools:["code","docs","web"],             memory:true,  created:"2024-01-25", prompt:"Ты Kai Tanaka — Full-Stack разработчик. Пишешь код, проводишь code review." },
  { id:"a28", name:"Emma Johansson",     role:"DevOps Engineer",             dept:"dev",       emoji:"🛠️", color:"#10b981", description:"CI/CD, Kubernetes, мониторинг и автоматизация инфраструктуры.",                                  model:"claude-sonnet-5",  status:"active", runs:0, rating:0, speed:"fast",   cost:"$$",  tools:["code","docs","web"],             memory:true,  created:"2024-02-01", prompt:"Ты Emma Johansson — DevOps инженер. Настраиваешь CI/CD, управляешь инфраструктурой." },
  { id:"a29", name:"Lucas Hoffmann",     role:"Security Engineer",           dept:"dev",       emoji:"🔐", color:"#8b5cf6", description:"Безопасность приложений, pentest и соответствие стандартам.",                                     model:"claude-opus-4-8",  status:"idle",   runs:0, rating:0, speed:"medium", cost:"$$$", tools:["code","web","docs"],             memory:true,  created:"2024-02-08", prompt:"Ты Lucas Hoffmann — Security Engineer. Проводишь аудиты безопасности, pentest." },
  { id:"a30", name:"Aisha Johnson",      role:"ML Engineer",                 dept:"dev",       emoji:"🧠", color:"#f43f5e", description:"Обучение моделей, MLOps и продуктовые ML-решения.",                                               model:"claude-opus-4-8",  status:"active", runs:0, rating:0, speed:"slow",   cost:"$$$", tools:["code","docs","analytics"],       memory:true,  created:"2024-02-15", prompt:"Ты Aisha Johnson — ML Engineer. Обучаешь модели, выстраиваешь MLOps пайплайны." },
  { id:"a31", name:"Oscar Lindqvist",    role:"Backend Engineer",            dept:"dev",       emoji:"⚙️", color:"#f59e0b", description:"API дизайн, базы данных, микросервисы и производительность.",                                   model:"claude-sonnet-5",  status:"active", runs:0, rating:0, speed:"fast",   cost:"$$",  tools:["code","docs"],                   memory:false, created:"2024-02-20", prompt:"Ты Oscar Lindqvist — Backend Engineer. Проектируешь API, оптимизируешь базы данных." },
  { id:"a32", name:"Julia Santos",       role:"QA Engineer",                 dept:"dev",       emoji:"🧪", color:"#a78bfa", description:"Тест-планы, автоматизация тестирования и контроль качества.",                                   model:"claude-sonnet-5",  status:"idle",   runs:0, rating:0, speed:"fast",   cost:"$",   tools:["code","docs"],                   memory:false, created:"2024-03-01", prompt:"Ты Julia Santos — QA Engineer. Пишешь тест-планы, автоматизируешь тестирование." },
  { id:"a33", name:"Benjamin Clark",     role:"Mobile Developer",            dept:"dev",       emoji:"📲", color:"#3b82f6", description:"iOS/Android разработка, React Native и производительность мобильных приложений.",               model:"claude-sonnet-5",  status:"active", runs:0, rating:0, speed:"fast",   cost:"$$",  tools:["code","docs","web"],             memory:false, created:"2024-03-05", prompt:"Ты Benjamin Clark — Mobile Developer. Разрабатываешь iOS/Android приложения." },
  { id:"a34", name:"Clara Novak",        role:"Data Analyst",                dept:"analytics", emoji:"📊", color:"#10b981", description:"SQL, дашборды, когортный анализ и KPI-репортинг.",                                               model:"claude-sonnet-5",  status:"active", runs:0, rating:0, speed:"fast",   cost:"$",   tools:["analytics","calculator","docs"], memory:false, created:"2024-02-05", prompt:"Ты Clara Novak — Data Analyst. Строишь дашборды, делаешь когортный анализ." },
  { id:"a35", name:"Hugo Petit",         role:"Business Intelligence",       dept:"analytics", emoji:"🔭", color:"#8b5cf6", description:"BI-инфраструктура, warehousing и executive-репорты.",                                            model:"claude-sonnet-5",  status:"idle",   runs:0, rating:0, speed:"medium", cost:"$$",  tools:["analytics","docs"],              memory:true,  created:"2024-02-10", prompt:"Ты Hugo Petit — BI-специалист. Строишь data warehouse, создаёшь executive-репорты." },
  { id:"a36", name:"Mia Eriksson",       role:"Data Scientist",              dept:"analytics", emoji:"🔮", color:"#f43f5e", description:"Предиктивные модели, NLP и data science проекты.",                                               model:"claude-opus-4-8",  status:"active", runs:0, rating:0, speed:"slow",   cost:"$$$", tools:["code","analytics","docs"],       memory:true,  created:"2024-02-15", prompt:"Ты Mia Eriksson — Data Scientist. Строишь предиктивные модели, работаешь с NLP." },
  { id:"a37", name:"Ahmed Hassan",       role:"Market Research Analyst",     dept:"analytics", emoji:"🌐", color:"#f59e0b", description:"Рыночные исследования, конкурентный анализ и потребительские тренды.",                           model:"claude-sonnet-5",  status:"idle",   runs:0, rating:0, speed:"fast",   cost:"$",   tools:["web","docs","analytics"],        memory:false, created:"2024-02-20", prompt:"Ты Ahmed Hassan — аналитик рынка. Исследуешь рынки, анализируешь конкурентов." },
  { id:"a38", name:"Yuki Watanabe",      role:"Reporting Specialist",        dept:"analytics", emoji:"📑", color:"#a78bfa", description:"Автоматизация отчётов, визуализация данных и storytelling.",                                   model:"claude-sonnet-5",  status:"active", runs:0, rating:0, speed:"fast",   cost:"$",   tools:["docs","analytics"],              memory:false, created:"2024-03-01", prompt:"Ты Yuki Watanabe — специалист по отчётности. Автоматизируешь репорты." },
  { id:"a39", name:"Francesca Ricci",    role:"Corporate Lawyer",            dept:"legal",     emoji:"⚖️", color:"#3b82f6", description:"Корпоративное право, сделки M&A и защита интересов компании.",                                 model:"claude-opus-4-8",  status:"idle",   runs:0, rating:0, speed:"slow",   cost:"$$$", tools:["docs","web"],                    memory:true,  created:"2024-02-01", prompt:"Ты Francesca Ricci — корпоративный юрист. Консультируешь по корпоративному праву." },
  { id:"a40", name:"Daniel Wright",      role:"IP & Patent Attorney",        dept:"legal",     emoji:"📜", color:"#8b5cf6", description:"Защита интеллектуальной собственности, патенты и торговые марки.",                             model:"claude-opus-4-8",  status:"idle",   runs:0, rating:0, speed:"slow",   cost:"$$$", tools:["docs","web"],                    memory:true,  created:"2024-02-10", prompt:"Ты Daniel Wright — патентный поверенный. Защищаешь интеллектуальную собственность." },
  { id:"a41", name:"Sophia Turner",      role:"Contract Specialist",         dept:"legal",     emoji:"📄", color:"#10b981", description:"Подготовка, анализ и переговоры по договорам.",                                                 model:"claude-sonnet-5",  status:"active", runs:0, rating:0, speed:"medium", cost:"$$",  tools:["docs"],                          memory:true,  created:"2024-02-15", prompt:"Ты Sophia Turner — специалист по договорам. Анализируешь и готовишь контракты." },
  { id:"a42", name:"Marcus Johnson",     role:"HR Director",                 dept:"hr",        emoji:"👥", color:"#f43f5e", description:"Talent acquisition, HR-политики и корпоративная культура.",                                     model:"claude-sonnet-5",  status:"active", runs:0, rating:0, speed:"fast",   cost:"$$",  tools:["web","docs"],                    memory:true,  created:"2024-02-20", prompt:"Ты Marcus Johnson — HR директор. Управляешь талантами, формируешь культуру." },
  { id:"a43", name:"Luna Petrov",        role:"Recruiter",                   dept:"hr",        emoji:"🎯", color:"#f59e0b", description:"Поиск кандидатов, интервью и онбординг новых сотрудников.",                                     model:"claude-sonnet-5",  status:"idle",   runs:0, rating:0, speed:"fast",   cost:"$",   tools:["web","docs"],                    memory:false, created:"2024-03-01", prompt:"Ты Luna Petrov — рекрутер. Ищешь и оцениваешь кандидатов, проводишь онбординг." },
  { id:"a44", name:"George Adams",       role:"L&D Specialist",              dept:"hr",        emoji:"📚", color:"#a78bfa", description:"Обучение и развитие, программы повышения квалификации.",                                        model:"claude-sonnet-5",  status:"active", runs:0, rating:0, speed:"fast",   cost:"$",   tools:["docs","web"],                    memory:true,  created:"2024-03-05", prompt:"Ты George Adams — L&D специалист. Разрабатываешь обучающие программы." },
  { id:"a45", name:"Isabelle Dupont",    role:"Market Research Lead",        dept:"research",  emoji:"🔍", color:"#3b82f6", description:"Первичные исследования, фокус-группы и исследование потребителей.",                             model:"claude-opus-4-8",  status:"active", runs:0, rating:0, speed:"medium", cost:"$$$", tools:["web","docs","analytics"],        memory:true,  created:"2024-02-05", prompt:"Ты Isabelle Dupont — руководитель исследований. Проводишь фокус-группы, рыночные исследования." },
  { id:"a46", name:"Raj Patel",          role:"Competitive Intelligence",    dept:"research",  emoji:"🕵️", color:"#10b981", description:"Мониторинг конкурентов, анализ трендов и battlecard.",                                         model:"claude-sonnet-5",  status:"idle",   runs:0, rating:0, speed:"fast",   cost:"$$",  tools:["web","docs","analytics"],        memory:false, created:"2024-02-15", prompt:"Ты Raj Patel — конкурентная разведка. Мониторишь конкурентов, создаёшь battlecard." },
];
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 8, marginTop: 13, paddingTop: 12, borderTop: "1px solid rgba(255,255,255,0.06)" }}>
        ...
        <span style={{ marginLeft: "auto", fontSize: 10, color: "rgba(255,255,255,0.3)", fontVariantNumeric: "tabular-nums", flexShrink: 0 }}>
          {agent.runs > 0 ? `${agent.runs} запусков` : "ещё не запускали"}
        </span>
      </div>
        ...
        <AnimatePresence mode="wait">
          ...
          {tab === "stats" && (
            <motion.div key="st" initial="hidden" animate="show" variants={{ show: { transition: { staggerChildren: 0.07 } } }}>
              {[
                { label: "Ваших запусков",   value: agent.runs.toLocaleString(), color: "#8b5cf6", pct: Math.min(100, agent.runs * 5) },
                { label: "Модель",            value: agent.model,                 color: "#3b82f6", pct: 100 },
                { label: "Направление",       value: DEPARTMENTS.find(d => d.id === agent.dept)?.label ?? agent.dept,       color: "#10b981", pct: 100 },
                { label: "Память диалога",    value: agent.memory ? "включена" : "выключена", color: "#f59e0b", pct: agent.memory ? 100 : 20 },
              ].map((s) => (
