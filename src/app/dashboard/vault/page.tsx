...
const TYPE_DESC: Record<NodeType, string> = {
  agent:    "Среита, командный агента",
  topic:    "Библиотека iot топик-хаб",
  memory:   "Память, отдаоется память",
  doc:      "Считает сляживается документ",
  artifact: "Артефакт поведимии аотекдиинистов",
  config:   "Конфиг посстакотаи конфиг",
};
